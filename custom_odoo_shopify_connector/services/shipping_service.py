...
class ShopifyShippingService:
    ...
    def _get_tracking_payloads(self, picking, default_carrier):
        ...
        Supports single picking tracking and multiple packages (stock.quant.package)
        with carrier_tracking_ref. Each package sends a separate fulfillment to Shopify.
        """
        result = []
